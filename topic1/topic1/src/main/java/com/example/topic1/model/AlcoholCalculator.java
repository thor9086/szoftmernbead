...
public class AlcoholCalculator {
    ...
    public static double alcoholPersonCalc(Person person) {
        ...
        int gender = person.getNem();
        double weightKg = person.getSuly();
        int level = person.getMertek();
    ...
    public static double alcoholDrinkCalc(Italok ital) {

        double volumeLiters = ital.getLength();
        double abv = ital.getAlcohol();
